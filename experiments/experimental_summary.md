...
2. **λ trade-off:** λ=1.0 gives best F1 but slowest fault reaction (19 windows). Lower λ (<=0.80) reacts in 0-3 windows but ~2% lower F1. Users must choose based on application priority.
